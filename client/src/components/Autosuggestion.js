...
import { Menu, Icon, Image, Dropdown, Label, Button, Divider, List } from "semantic-ui-react";
...
function renderSuggestion({ firstName, lastName, username, profilePicture }) {
  return (
    <List>
      <List.Item href={"/" + username}>
        <Image size="mini" src={"/images/profile-picture/100x100/" + profilePicture} rounded/>
        <List.Content>
